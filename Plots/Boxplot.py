...
def main(
   ...
   # Create the box plots
    ...
    plt.suptitle('Makespan distribution per arrival time accross batch sizes')
    ...
    # plt.suptitle('Total deviation distribution per arrival time accross batch sizes')
    # plt.tight_layout()
    # plt.show()
...
inst="3020"
print("Boxplot:", inst)
main(inst=inst, batch1="b_1",batch2="b_2",batch3="b_3", arr_time="60")
