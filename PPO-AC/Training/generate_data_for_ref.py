...
def optimize(instance, dur, seq,n_mch, n_job,max_time = 1000000, time_limit = 100, threads = 1):
...
def optimize_and_visualize(n_mch, n_job,dur,seq, time_limit = 100, threads = 1):
    ...
    # print(seq)
    return mchsStartTimes, opIDsOnmchs,end, solution_sequence
...
if __name__ == '__main__':
    ...
    mchsStartTimes, opIDsOnmchs,end, solution_sequence=optimize_and_visualize(m,j,dur,seq, 1000, 1)
