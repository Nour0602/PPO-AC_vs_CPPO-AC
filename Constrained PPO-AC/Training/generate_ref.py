...
def test():  
    ...
    parser.add_argument('--Pn_m', type=int, default=50, help='Number of machines instances to test')
    parser.add_argument('--Nn_j', type=int, default=400, help='Number of jobs on which to be loaded net are trained')
    parser.add_argument('--Nn_m', type=int, default=50, help='Number of machines on which to be loaded net are trained')
    ...
    ppo.policy.load_state_dict(torch.load(path, map_location=torch.device('cuda:1')))
