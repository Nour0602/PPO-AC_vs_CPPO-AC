...
#Dimensions preparing, Data preparing
    ...
    # location="./"+inst+"/compare_models/model0/"+batch+"/"+arr_time+"/"
    ...
    path = './5050/{}.pth'.format(str(50) + '_' + str(150) + '_' + str(LOW) + '_' + str(HIGH))
    ...
    # path = './1515/compare_models/NB_JB/{}.pth'.format(str(15) + '_' + str(115) + '_' + str(LOW) + '_' + str(HIGH))
        ...
        while hour<=tresh:
            ...
            if add_poisson!=0:
                ...
                while True:
                    ...
                    with torch.no_grad():
                        pi,v,v_c  = ppo.policy(x=fea_tensor.float(),
    ...
    scenarios_file=open(location+"dico_data_multi.pkl", "wb")
...
if __name__ == "__main__":
    ...
    # main(n_jobs=n_jobs,n_machines=n_machines,inst=inst,batch="b_1",arr_time="60",born=(0.6,0.7),add=1,)
    # print("inst=inst, batch=b_1, arr_time=60: done.")
    # main(n_jobs=n_jobs,n_machines=n_machines,inst=inst,batch="b_2",arr_time="60",born=(0.6,0.7),add=2,)
    # print("inst=inst, batch=b_2, arr_time=60: done.")
    # main(n_jobs=n_jobs,n_machines=n_machines,inst=inst,batch="b_3",arr_time="60",born=(0.6,0.7),add=3,)
    # print("inst=inst, batch=b_3, arr_time=60: done.")



    # main(n_jobs=n_jobs,n_machines=n_machines,inst=inst,batch="b_1",arr_time="90",born=(0.9,0.9),add=1,)
    # print("inst=inst, batch=b_1, arr_time=90: done.")
    # main(n_jobs=n_jobs,n_machines=n_machines,inst=inst,batch="b_2",arr_time="90",born=(0.9,0.9),add=2,)
    # print("inst=inst, batch=b_2, arr_time=90: done.")
    # main(n_jobs=n_jobs,n_machines=n_machines,inst=inst,batch="b_3",arr_time="90",born=(0.9,0.9),add=3,)
    # print("inst=inst, batch=b_3, arr_time=90: done.")   
