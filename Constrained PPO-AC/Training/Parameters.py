...
# args for device
parser.add_argument('--device', type=str, default="cuda:1", help='Number of jobs of instances')
# args for env
parser.add_argument('--n_j', type=int, default=50, help='Number of jobs of instance')
parser.add_argument('--n_m', type=int, default=50, help='Number of machines instance')
...
# args for PPO
parser.add_argument('--num_envs', type=int, default=2, help='No. of envs for training')
...
# parser.add_argument('--entloss_coef', type=float, default=0.1, help='entropy loss coefficient')
