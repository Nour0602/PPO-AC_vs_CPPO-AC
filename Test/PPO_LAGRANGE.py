...
from agent_utils_re import eval_actions
from agent_utils_re import select_action
from actor_critic_re import ActorCriticCost
...
def main():
    ...
    # while (STOP==False) and (i_update<=1000):
    while  i_update<=10000:
        ...
        for i, env in enumerate(envs):
            ...
            # print('env', i)
            # data1,data2,start,mchIds,end, sol_seq=optimize_and_visualize(configs.n_m,configs.n_j,dur,seq, 3, 1)
            # print('data are',data1,data2,start)

            # print(  "End at time ref:", end)
             # print("i is:", i)
            # tuple_cmax[i]=end.max()
            tuple_cmax[i]=end
            # print("tuple cmax",tuple_cmax[i][1][14] )
            data=(data1,data2)
            # cost_limit=tuple_cmax[i]
            eliminated=sol_seq
           
            while (len(eliminated))>2250:
                eliminated.pop()
            # print("eliminated are:", eliminated, eliminated[-1], len(eliminated))
            ...
            mch_op=np.take(data2,op)-1
                # print(mch_op,op)
                # print(mchIds[mch_op])
                # print(np.where(mchIds[mch_op]==op))
            ...
            # print("hour is :",hour2,hour1,hour)
        ...
        # print('penalty_list',penalty_list, mean_cost, penalty_loss,v_loss)
        ...
        if i_update%1000==0:
            file_writing_log=open('/media/nas/nehammami/Manuscript_4th_2024/5050/new_de/' + 'log_' + str(configs.n_j) + '_' + str(configs.n_m) + '_' + str(configs.low) + '_' + str(configs.high) + '.txt', 'w')
            file_writing_log.write(str(log))

            file_writing_lg_loss = open(
            '/media/nas/nehammami/Manuscript_4th_2024/5050/new_de/' + 'lg_loss_' + str(configs.n_j) + '_' + str(configs.n_m) + '_' + str(configs.low) + '_' + str(configs.high) + '.txt', 'w')
            file_writing_lg_loss.write(str(lg_coef)) 

            file_writing_cost_limit = open(
            '/media/nas/nehammami/Manuscript_4th_2024/5050/new_de/' + 'cost_limit_' + str(configs.n_j) + '_' + str(configs.n_m) + '_' + str(configs.low) + '_' + str(configs.high) + '.txt', 'w')
            file_writing_cost_limit.write(str(cost_limit_list)) 

            
            file_writing_pen_loss = open(
            '/media/nas/nehammami/Manuscript_4th_2024/5050/new_de/' + 'pen_loss_' + str(configs.n_j) + '_' + str(configs.n_m) + '_' + str(configs.low) + '_' + str(configs.high) + '.txt', 'w')
            file_writing_pen_loss.write(str(data_pen_loss)) 

            file_writing_pen_co = open(
            '/media/nas/nehammami/Manuscript_4th_2024/5050/new_de/' + 'pen_co_' + str(configs.n_j) + '_' + str(configs.n_m) + '_' + str(configs.low) + '_' + str(configs.high) + '.txt', 'w')
        ...
        if (i_update + 1) == window_size:
            ...
            torch.save(ppo_1.policy.state_dict(), '/media/nas/nehammami/Manuscript_4th_2024/5050/new_de/{}.pth'.format(
            ...
            if R_i> R_max:
                ...
                file_writing_rew_window=open('/media/nas/nehammami/Manuscript_4th_2024/5050/new_de/'+'moving_rew_'+ str(configs.n_j) + '_' + str(configs.n_m) + '_' + str(configs.low) + '_' + str(configs.high) + '.txt', 'w')
                file_writing_rew_window.write(str(moving_avg))
           
                
                file_writing_vloss=open('/media/nas/nehammami/Manuscript_4th_2024/5050/new_de/' + 'VLoss_' + str(configs.n_j) + '_' + str(configs.n_m) + '_' + str(configs.low) + '_' + str(configs.high) + '.txt', 'w')
                file_writing_vloss.write(str(data_v_loss))

                file_writing_cost_window=open('/media/nas/nehammami/Manuscript_4th_2024/5050/new_de/' + 'moving_cost_' + str(configs.n_j) + '_' + str(configs.n_m) + '_' + str(configs.low) + '_' + str(configs.high) + '.txt', 'w')
                file_writing_cost_window.write(str(moving_cost))
               
                file_writing_obj1 = open(
                '/media/nas/nehammami/Manuscript_4th_2024/5050/new_de/' + 'valiMSP_' + str(configs.n_j) + '_' + str(configs.n_m) + '_' + str(configs.low) + '_' + str(configs.high) + '.txt', 'w')
                file_writing_obj1.write(str(moving_ms))
            
                file_writing_obj2 = open(
                '/media/nas/nehammami/Manuscript_4th_2024/5050/new_de/' + 'valiDEVP_' + str(configs.n_j) + '_' + str(configs.n_m) + '_' + str(configs.low) + '_' + str(configs.high) + '.txt', 'w')
